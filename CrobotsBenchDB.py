...
Version History:
                Version 1.7 Support for balanced scoring systems
                Version 1.6 Support for testing binary robot only (if no source code '.r' available, e.g. KOTH)
